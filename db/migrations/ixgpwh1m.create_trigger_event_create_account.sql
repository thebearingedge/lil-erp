...
create function create_account(stream_id uuid, payload jsonb) returns void as $$
  declare
...
create function event_create_account() returns trigger as $$
  begin
    perform create_account(new.stream_id, new.payload);
    return new;
  end;
$$ language plpgsql;
