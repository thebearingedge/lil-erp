...
create function create_customer(stream_id uuid, payload jsonb) returns void as $$
  declare
...
create function event_create_customer() returns trigger as $$
  begin
    perform create_customer(new.stream_id, new.payload);
    return new;
  end;
$$ language plpgsql;
